...
const PersonalGallery = ({ artistFriend, position = [0, 0, 0] }) => {
  ...
  const personalArtwork = {
    'suite-1': [ // Sarah Mitchell - Painter
    ...
    'suite-2': [ // Marcus Rodriguez - Musician  
    ...
    'suite-3': [ // Elena Kowalski - Photographer
    ...
    'suite-5': [ // Isabella Romano - Sculptor
    ...
    'suite-6': [ // James Thompson - Digital Artist
  ...
  const artwork = personalArtwork[artistFriend.id] || [];
