...
import { RigidBody, CuboidCollider } from '@react-three/cannon';
  ...
  return (
    <group position={position} ref={cabinRef}>
      ...
      <RigidBody type="fixed">
        {/* Main Walls */}
        <Box args={[8, 4, 6]} position={[0, 2, 0]} castShadow receiveShadow>
          <primitive object={logMaterial} attach="material" />
        </Box>
        <CuboidCollider args={[4, 2, 3]} position={[0, 2, 0]} />
      ...
      {/* Porch */}
      <RigidBody type="fixed">
        <Box args={[10, 0.3, 3]} position={[0, 0.15, 4.5]} receiveShadow>
          <meshStandardMaterial color="#8B7355" roughness={0.9} />
        </Box>
        <CuboidCollider args={[5, 0.15, 1.5]} position={[0, 0.15, 4.5]} />
